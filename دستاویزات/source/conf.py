...
#
# html_sidebars = {}
html_logo = "source/_static/تسویر_چھوٹی.png"
...
latex_documents = [
    (master_doc, 'sphinx.tex', 'تقدیر Documentation',
     'ژولیئں ملاغ، محمّد اظہر انعام بیگ', 'manual'),
]
...
man_pages = [
    (master_doc, 'sphinx', 'تقدیر Documentation',
     [author], 1)
]
