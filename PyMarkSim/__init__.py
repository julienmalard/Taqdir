...
مسل_قابو = وسائل_کا_نام('PyMarkSim', 'مسل_مرکسم.json')
...
if not os.path.isfile(مسل_مرکسم):
    if مسل_مرکسم == "":
        انتباہ('مرکسم کا مسل نہیں ملی. اسے "PyMarkSim.مرکسم_وضاحت_کریں()" سے وضاحت کیجئے.')
elif not os.path.isdir(مسل_مرکسم):
        انتباہ('مرکسم کا مسل کا راستہ سہی نہیں ہے. اسے "PyMarkSim.مرکسم_وضاحت_کریں()" سے ٹھیک کر دیجئے.')
