...
class امتحان_مقام(unittest.TestCase):
    ...
    def setUpClass(قسم):
        ...
        قسم.جگہ = dict(چوڑائی=11.02, طول=76.96, بلندی=1)
        قسم.مقام = مقام(**قسم.جگہ)

        قسم.مسل_سی_اس = سی_اس_وی(مسل_سی_اس_وی, **قسم.جگہ, تبدل_ستون=تبدل)
    ...
    def test_خاکے(خود):
        ذر = سی_اس_وی(مسل_سی_اس_وی, **خود.جگہ, تبدل_ستون=تبدل, خاکے='۲۔۶')
