...
class ذریعہ(object):
    ...
    def _کوائف_بنانا(خود, سے, تک, عرض, طول, بلندی, خاکے):
        ...
        -------
        pd.DataFrame:
            کوائف، پاندس میں۔ اگر ان تاریخ، جگہ، یا خاکے کے لئے اس ذریعے میں کوائف دستیاب نہیں ہیں، تو پھر
             ``None`` واپس دینا۔ پاندس کا اشاریہ pd.PeriodIndex ہونا چاہئے۔ اشاریہ روزانہ، ماہانہ، سا لانہ
             کا ہو سکتا ہے۔
        """
