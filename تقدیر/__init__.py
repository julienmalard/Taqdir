...
مسل_قابو = وسائل_کا_نام('تقدیر', 'مسل_مرکسم.json')
...
if not os.path.isfile(مسل_مرکسم):
    if مسل_مرکسم == "":
        انتباہ('مرکسم کا مسل نہیں ملی. اسے "تقدیر.مرکسم_وضاحت_کریں()" سے وضاحت کیجئے.')
    if not os.path.isdir(مسل_مرکسم):
        انتباہ('مرکسم کا مسل کا راستہ سہی نہیں ہے. اسے "تقدیر.مرکسم_وضاحت_کریں()" سے ٹھیک کر دیجئے.')
