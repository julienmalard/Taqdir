...
class ذریعہ(object):
    ...
    def اعداد_پانا(خود, سے, تک, ر_ح_را=None, ش_ترکار=1, usar_caché=True, دوبارہ_پیدا=False):

        if دوبارہ_پیدا:
            خود.اعداد_پیدا_کرنا(سے=سے, تک=تک, ر_ح_را=ر_ح_را, ش_ترکار=ش_ترکار, usar_caché=usar_caché)
        else:
    ...
    def اعداد_پیدا_کرنا(خود, سے, تک, ر_ح_را, ش_ترکار, usar_caché):
        ...
        اعداد = خود._اعداد_پیدا_کرنا(سے=سے, تک=تک, ر_ح_را=ر_ح_را, ش_ترکار=ش_ترکار, پہلہ_ہونےولے_اشتمال=usar_caché)
